...
hist(f_muestras, breaks = 30, probability = TRUE,
     main = paste("Histograma de muestras de F(1, n) | PDF teórica"),
     xlab = "x", col = "steelblue", xlim = c(0, max(f_muestras)))
curve(df(x, 1, gl), col = "red", lwd = 2, add = TRUE)
legend("topright", legend = c("Muestras simuladas", "PDF teórica"), col = c("steelblue", "red"), lwd = 2)
```
...
hist(inv_f_muestras, breaks = 30, probability = TRUE,
     main = paste("Histograma de muestras de F(b, a) | PDF teórica"),
     xlab = "x", col = "#CDB5CD", xlim = c(0, max(inv_f_muestras)))
curve(df(x, b, a), col = "red", lwd = 2, add = TRUE)
legend("topright", legend = c("Muestras simuladas", "PDF teórica"), col = c("#CDB5CD", "red"), lwd = 2)
```
...
hist(f_muestras, breaks = 30, probability = TRUE,
     ...
     xlab = "x", col = "seagreen3", xlim = c(0, max(f_muestras)))
curve(df(x, a, b), col = "red", lwd = 2, add = TRUE)
legend("topright", legend = c("Muestras simuladas", "PDF teórica"), col = c("seagreen3", "red"), lwd = 2)
```
:::
